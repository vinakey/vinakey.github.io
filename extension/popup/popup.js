...
class VinaKeyPopup {
  ...
  updateUI() {
    ...
    // Update status text
    this.statusText.textContent = this.settings.enabled ? 'Enabled' : 'Disabled';
    this.statusText.className = this.settings.enabled ? 'toggle-status enabled' : 'toggle-status disabled';
